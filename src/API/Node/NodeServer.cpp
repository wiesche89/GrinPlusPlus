                                    ...
                                    const IDatabasePtr& pDatabase)
{
    ...
    //pOwnerServer->AddMethod("validate_chain", std::shared_ptr<RPCMethod>(new GetValidateChainHandler(pBlockChain, pP2PServer)));
    //pOwnerServer->AddMethod("compact_chain", std::shared_ptr<RPCMethod>(new GetCompactChainHandler(pBlockChain, pP2PServer)));
